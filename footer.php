			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="frontend/img/online-shop-logo_18099-275.webp" alt="">
						</a>
					</div>
					<!-- /footer logo -->

					<p>Toko online penyedia berbagai kebutuhan bagi anda khususnya gen Z, tersedia berbagai macam produk dengan kualitas terbaik.</p>
					<div>saran : 082218846623</div>
				</div>
			</div>
			<!-- /footer widget -->
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 text-center">
				...
				<div class="footer-copyright">
					...
					Copyright &copy;<script>document.write(new Date().getFullYear());</script> TokoOnlineShop
